class Animal: 
    ...
    #Constructor 构造函数
    def __init__(self, name, species, age, energy=100):#instance level data -- all available through instance of class
        self.name = name
...
#charlie=Animal(name="charlie",species="Parrot",age=2,energy=110)
